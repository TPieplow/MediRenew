    ...
    public partial class InitialMigrationWithSeed : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Headfraction", new DateTime(2024, 1, 23, 14, 2, 35, 373, DateTimeKind.Local).AddTicks(7206) },
                    { 2, 2, "Pungbråck", new DateTime(2024, 1, 23, 14, 2, 35, 373, DateTimeKind.Local).AddTicks(7250) },
                    { 3, 3, "Headfraction", new DateTime(2024, 1, 23, 14, 2, 35, 373, DateTimeKind.Local).AddTicks(7253) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 10.0m, new DateTime(2024, 1, 23, 14, 2, 35, 373, DateTimeKind.Local).AddTicks(7301), 1, "Every 4 hour", 1, 1 },
                    { 2, 5.0m, new DateTime(2024, 1, 23, 14, 2, 35, 373, DateTimeKind.Local).AddTicks(7308), 2, "Every 4 hour", 2, 2 },
                    { 3, 50.0m, new DateTime(2024, 1, 23, 14, 2, 35, 373, DateTimeKind.Local).AddTicks(7310), 3, "Twice a day, morning and before bed", 3, 3 }
                });

    ...
    public partial class Test : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Headfraction", new DateTime(2024, 1, 18, 14, 31, 24, 702, DateTimeKind.Local).AddTicks(6315) },
                    { 2, 2, "Pungbråck", new DateTime(2024, 1, 18, 14, 31, 24, 702, DateTimeKind.Local).AddTicks(6363) },
                    { 3, 3, "Headfraction", new DateTime(2024, 1, 18, 14, 31, 24, 702, DateTimeKind.Local).AddTicks(6368) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 10.0m, new DateTime(2024, 1, 18, 14, 31, 24, 702, DateTimeKind.Local).AddTicks(6414), 1, "Every 4 hour", "Ibuprofen", 1, 1 },
                    { 2, 5.0m, new DateTime(2024, 1, 18, 14, 31, 24, 702, DateTimeKind.Local).AddTicks(6420), 2, "Every 4 hour", "Paracetamol", 2, 2 },
                    { 3, 50.0m, new DateTime(2024, 1, 18, 14, 31, 24, 702, DateTimeKind.Local).AddTicks(6424), 3, "Twice a day, morning and before bed", "Beta-adrenergic blockers", 3, 3 }
                });
